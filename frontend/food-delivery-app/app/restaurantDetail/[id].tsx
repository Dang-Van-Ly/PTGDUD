...
export default function RestaurantDetailScreen() {
  ...
  const forYou = [
    { name: "Fried Chicken", price: 15, rating: 4.5, img: "https://images.unsplash.com/photo-1606756790138-06c7eaaae5f8" },
    { name: "Chicken Salad", price: 16, rating: 4.5, img: "https://images.unsplash.com/photo-1550547660-d9450f859349" },
    { name: "Spicy Chicken", price: 15, rating: 4.5, img: "https://images.unsplash.com/photo-1606755962773-3d47fcb7e62e" },
    { name: "Fried Potatoes", price: 15, rating: 4.3, img: "https://images.unsplash.com/photo-1555939594-58d7cb561ad1" },
  ];

  const menu = [
    { name: "Saute Chicken Rice", desc: "Saute chicken, rice", price: 15, rating: 4.6, img: "https://images.unsplash.com/photo-1604908177522-04009d3e38b5" },
    { name: "Chicken Burger", desc: "Fried chicken, cheese & burger", price: 15, rating: 4.5, img: "https://images.unsplash.com/photo-1618213837799-66c3e8e1c49e" },
  ];
...
const styles = StyleSheet.create({
  ...
  header: {
    position: "absolute",
    top: 130, // đè lên phần dưới của banner
    left: 20,
    right: 20,
    backgroundColor: "#fff",
    borderRadius: 5,
  ...
  foodImg: { width: "100%", height: 90, borderTopLeftRadius: 10, borderTopRightRadius: 10 },
  foodName: { fontWeight: "600", marginTop: 5, textAlign: "center" },
  foodPrice: { textAlign: "center", color: "#00BCD4", marginTop: 2 },
  foodRating: { textAlign: "center", color: "#888", fontSize: 12 },
  menuItem: { flexDirection: "row", marginBottom: 15 },
  menuImg: { width: 80, height: 80, borderRadius: 10 },
  menuName: { fontWeight: "600", fontSize: 16 },
  menuDesc: { color: "#777", fontSize: 13, marginVertical: 4 },
  menuPrice: { color: "#00BCD4" },
  reviewCard: {
