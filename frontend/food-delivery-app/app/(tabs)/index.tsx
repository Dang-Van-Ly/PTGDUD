  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.scrollArea} showsVerticalScrollIndicator={false}>
        {/* BANNER */}
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ marginVertical: 15 }}>
          {banners.map((item) => (
            <View key={item.id} style={[styles.bannerCard, { backgroundColor: item.color }]}>
              <View style={styles.bannerLeft}>
                ...
                <TouchableOpacity style={[styles.bannerButton, { backgroundColor: item.colorButton }]}>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.categories}>
          {categories.map((item) => (
           <TouchableOpacity key={item.id} style={styles.categoryItem} onPress={() =>
                router.push({
